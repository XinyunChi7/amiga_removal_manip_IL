...
'''
NOT USED
Conv-LSTM-MLP model for image regreesion, 
...
import wandb
wandb.init(
    project="amiga-IL-conv-lstm-mlp-reg-mask",
    config={
    "learning_rate": 0.005,
    "batch_size": 32
    }
...
original_targets = load_targets_from_file(targets_file='C:/D/Imperial/Thesis/amiga_dataset/IL/act_pred_dataset/train/targets.txt')
...
# Load dataset
train_images_folder = 'C:/D/Imperial/Thesis/amiga_dataset/IL/act_pred_dataset/train/'
train_targets_file = 'C:/D/Imperial/Thesis/amiga_dataset/IL/act_pred_dataset/train/targets.txt'
test_images_folder = 'C:/D/Imperial/Thesis/amiga_dataset/IL/act_pred_dataset/test/'
test_targets_file = 'C:/D/Imperial/Thesis/amiga_dataset/IL/act_pred_dataset/test/targets.txt'
