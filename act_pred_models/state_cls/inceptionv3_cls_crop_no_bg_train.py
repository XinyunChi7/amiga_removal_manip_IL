...
#     project="amiga-IL-classification",
#     # track hyperparameters and run metadata
#     config={
#     # "architecture": "inceptiv3",
#     # "dataset": "amiga-remove-IL",
...
# init to store accuracy and loss values
train_loss_values = []
train_accuracy_values = []

# Training loop
num_epochs = 50  # 50 epoches > accuracy 76.27 
for epoch in range(num_epochs):
    ...
    # Calculate training accuracy and loss for current epoch
    ...
    # wandb.log({"acc":  epoch_accuracy, "loss":  epoch_loss})
...
# Optional: testing performance with confusion matrix can be found in 'inceptionv3_cls_test.py'
# Test the model
model.eval()
with torch.no_grad():
    correct = 0
