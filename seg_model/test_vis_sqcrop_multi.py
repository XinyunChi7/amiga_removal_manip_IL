...
Might be further applied as inputs for regression model.

Check 'test_vis_crop_multi.py' for CROPPED with a box centered at the lowest point in mask[1] (whisk).
...
root = 'C:/D/Imperial/Thesis/amiga_dataset/cv_eef_dataset/imgs_test/whisk_with_hook/imgs_without_first19_30'
...
def visualize_masks(image, masks, index):
    ...
    # Crop (centered at the raw image)
    x = int(image_np.shape[1] /2) 
    y = int(image_np.shape[2] /2)
    print("lowest_row:",  x)
    print("lowest_col:",  y)
    ...
    # Save cropped image
    output_folder = "C:/D/Imperial/Thesis/amiga_dataset/SAM_test/seg_test/all_data/crop_sq_0409/"
    plt.imshow(cropped_image)
    plt.axis('off')  
    ...
    # plt.show()
    # output_folder = 'C:/Users/seren/Desktop/crop_test/obj_centered/'
    # os.makedirs(output_folder, exist_ok=True)
